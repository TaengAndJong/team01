  ...
  const handleSubmit = async () => {
    ...
    Object.entries(createBook).forEach(([key, value]) => {
      ...
      if (key === "bookImg") {
        ...
        bookImg.new.forEach((img) => {
          // 누적값 저장은 forEach(), 새로운 배열 생성은 map()
    ...
    const hasEmpty = Array.from(formData.entries()).some(([key, value]) => {
      ...
      <div className="bookcreate">
        ...
        <form className="bookCreateForm" onSubmit={onSubmit}>
          ...
          <div className="d-flex align-items-center mb-1">
            ...
            {/*발행일*/}
            <PublishDate
              publishDate={createBook.publishDate}
          ...
          <div className="d-flex align-items-center mb-1 ">
            {/*재고 & 가격*/}
            <PriceStock
              bookPrice={createBook.bookPrice}
              stock={createBook.stock}
              stockStatus={createBook.stockStatus}
              handleChange={handleChange}
            />
          </div>
          <div className="d-flex align-items-center mb-1">
          ...
          {/*도서설명*/}
          <div className="d-flex align-items-center mb-1">
            <label htmlFor="bookDesc" className="form-title">
              도서설명
            </label>
            <textarea
              id="bookDesc"
              ...
              name="bookDesc"
              type="text"
              placeholder="도서설명 100글자 이내로 입력"
              value={createBook.bookDesc}
              aria-describedby="bookDescHelp"
              maxLength="100"
              required
              onChange={handleChange}
            />
        ...
        <div className="d-flex align-items-center justify-content-center mt-4">
          <Btn
            path={PathsData.page.adminBook}
            className={"login btn btn-danger mx-1"}
            text={"취소"}
          />
          <Btn
            className={"signup btn custom-btn02 mx-1"}
            text={"완료"}
            type="submit"
            onClick={onSubmit}
          />
