        ...
        <>
            <div className="mypage-dash">
                <div className="inner left">
                    <strong className="title d-inline-block mb-4">최근 본 도서목록</strong>
                    <ul className="recent-slide box-list">
                        <li className="li gray">
                            1
                        </li>
                        <li className="li gray">
                            2
                ...
                <div className="inner right">
                    <ul className="box-list d-flex flex-wrap">
                        <li className="li green">
                            ...
                            <span className="count ms-auto fw-bold"><em>10</em>건</span>
                        </li>
