        ...
        <>
            ...
            <aside id="sidebar" className="left-menu">
                <div className="left-title">
                    {/*현재경로의 부모 1차메뉴 이름*/}
                    <h4 className="sub-title first-title">도서관리</h4>
                </div>

                <ul className="depth first-depth">
                    <li className="">
                        {/*2차메뉴 있으면 이동 막고 2차메뉴 첫번재링크로 이동 */}
                        <button type="button" className="depth-menu first" title="1차메뉴 닫힘">
                            게시판
                    ...
                    <li>
                        {/*2차메뉴 있으면 이동 막고 2차메뉴 첫번재링크로 이동 */}
                        <button type="button" id="first-menu" className="depth-menu first" title="1차메뉴 닫힘">
                            도서관리
                            <i className="arrow circle-arrow"></i>
                        </button>
                        <ul className="depth second-depth">
